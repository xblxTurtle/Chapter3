 ...
 */
public class SimpleOscillatingAnimation extends JPanel implements ActionListener {
    ...
    public void drawFrame(Graphics g, int frameNumber, int width, int height) 
         ...
         */
    		int cyclicFrameNumber = Math.abs((frameNumber % 20) - 10);
    ...
    public static void main(String[] args) {
         ...
         */
        SimpleOscillatingAnimation drawingArea = new SimpleOscillatingAnimation();
